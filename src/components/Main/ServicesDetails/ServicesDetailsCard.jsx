...
const ServicesDetailsCard = ({ details }) => {
  const { id, title, image, description, price } = details || {};
  ...
  return (
    <div>
      <div className="bg-base-200 py-3 max-w-xs rounded-xl mx-auto mb-16">
        <h1 className=" text-center text-amber-500 text-4xl font-bold">
          Our Services
        </h1>
      </div>
      ...
      <div className="relative  md:flex md:w-full  md:flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
        ...
        <div className="p-6">
          ...
          <p className="mb-8 block font-sans text-base font-normal leading-relaxed text-gray-500 antialiased">
            {description}
          </p>
          <div>
      ...
      <div className="flex justify-center items-center gap-4  mt-12">
        <button
          ...
          className="btn bg-amber-500 capitalize text-white  text-xl"
        >
          Book Events
        </button>
        <Link to={"/"}>
          <button className="btn bg-gray-900 capitalize text-white  text-xl">
            Go Home
          </button>
        </Link>
      </div>
