    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto pb-16  justify-center item-center  gap-10">
      ...
      <div className="relative grid md:h-[450px] lg:h-[400px] w-full   flex-col items-end justify-center overflow-hidden rounded-xl bg-base-200 bg-clip-border border-4 border-amber-700  text-center ">
        ...
        <div className="relative p-6  px-6 md:px-12">
          ...
          <p className="md:h-[200px] lg:h-[180px] pt-3 text-gray-600   ">
            I recently participated in a Team Building Workshop with my
            colleagues. It was an incredible experience. We learned to
            communicate better, solved challenging tasks, and bonded like never
            before. Highly recommend it!
          </p>
          <h2 className="text-xl pt-3 font-bold text-black">Andy Smith</h2>
          <h5 className="mb-4 block font-sans text-sm  leading-snug tracking-normal text-gray-400 antialiased">
      ...
      <div className="relative grid md:h-[450px] lg:h-[400px] w-full  flex-col items-end justify-center overflow-hidden rounded-xl bg-base-200 bg-clip-border border-4 border-amber-700  text-center ">
        ...
        <div className="relative p-6  px-6 md:px-12">
          ...
          <p className="md:h-[200px] lg:h-[180px] pt-3 text-gray-600   ">
            The Product Launch event I attended was mind-blowing! The unveiling
            of the latest gadgets left me in awe. Kudos to the organizing team
            for such a spectacular show. It was worth every mile I traveled.
          </p>
          <h2 className="text-xl pt-3 font-bold text-black">Robert Brown</h2>
          <h5 className="mb-4 block font-sans text-sm  leading-snug tracking-normal text-gray-400 antialiased">
