...
const ServicesCard = ({ card }) => {
  const { id, title, image, short_description, price } = card || {};
        ...
        <div className="card-body text-center">
          ...
          <div className="">
            <Link to={`/cardDetails/${id}`}>
              <button className="btn bg-gradient-to-r from-amber-300 to-amber-500  capitalize text-xl font-bold text-white w-full">
                See Details
              </button>
            </Link>
          </div>
