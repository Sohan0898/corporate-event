...
const Services = ({ cards }) => {
  return (
    <div className="max-w-screen-2xl mx-auto px-6 md:px-8 lg:px-16 mb-12">
     ...
     data-aos-duration="2000" className="flex justify-between rounded-xl bg-gray-900 p-5 mb-16">
     ...
     data-aos-duration="2000"  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  justify-center item-center  gap-10">
        {cards?.map((card) => (
