          ...
          >
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="">
                ...
                <p className="mb-5">
                Welcome to Corporate Connect – Your Premier Destination for Exceptional Corporate Events! <br />
                Join us in the world of business excellence, where we transform ordinary gatherings into extraordinary experiences.
                </p>
                <div className="flex justify-center items-center gap-5 pt-3">
                  <button className="focus:outline-none text-white bg-amber-500 hover:bg-amber-500 focus:ring-4 focus:ring-amber-500 font-medium rounded-lg text-sm px-6 py-3 mr-2 mb-2 dark:focus:ring-amber-600">Explore</button>
